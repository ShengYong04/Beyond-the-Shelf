...
var fav_img2 = document.getElementById("fav_img2");
...
var account_img2 = document.getElementById("account_img2");
account2.addEventListener("mouseover",() => {
    account_img2.src = account_hover;
});

account2.addEventListener("mouseout",() => {
    account_img2.src = account_normal;
});
...
var cart_img2 = document.getElementById("cart_img2");
cart2.addEventListener("mouseover",() => {
    cart_img2.src = cart_hover;
});

cart2.addEventListener("mouseout",() => {
    cart_img2.src = cart_normal;
});

var setfav = document.getElementById("setfav");
var onlist = document.getElementById("onlist");
var preset = document.querySelector(".preset");
var gotfav = false;
onlist.addEventListener("click",() => {
    preset.classList.add("none");
});
